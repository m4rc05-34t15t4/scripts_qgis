...
class AuxVeg3(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        # Set default layers
        default_centroide_area_construida = 'centroide_area_construida_p'
        default_centroide_massa_dagua = 'centroide_massa_dagua_p'
        default_delimitadores_massa = ['delimitador_massa_dagua_l', 'infra_barragem_l', 'infra_via_deslocamento_l', 'elemnat_trecho_drenagem_l']
        default_delimitadores_area_construida = 'delimitador_area_construida_l'
        ...
        self.addParameter(QgsProcessingParameterMapLayer('centroide_area_construida', 'Centroide Área Construída', defaultValue=default_centroide_area_construida, types=[QgsProcessing.TypeVectorPoint]))
        self.addParameter(QgsProcessingParameterMapLayer('centroide_massa_dagua', 'Centroide Massa D Água', defaultValue=default_centroide_massa_dagua, types=[QgsProcessing.TypeVectorPoint]))
        self.addParameter(QgsProcessingParameterMultipleLayers('delimitadores_linhas_massa_dagua', 'Delimitadores Linhas Massa D Água', layerType=QgsProcessing.TypeVectorLine, defaultValue=default_delimitadores_massa))
        self.addParameter(QgsProcessingParameterMultipleLayers('delimitadores_linhas_area_construida', 'Delimitadores Linhas Área Construída', layerType=QgsProcessing.TypeVectorLine, defaultValue=default_delimitadores_area_construida))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        outputs['area_construida'] = processing.run('dsgtools:buildpolygonsfromcenterpointsandboundariesalgorithm', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        feedback.pushInfo('Generating massa_dagua polygon delimiters...')
        alg_params = {
            'ATTRIBUTE_BLACK_LIST': [''],
            'BOUNDARY_LINE_LAYER': None,
            'CHECK_INVALID_GEOMETRIES_ON_OUTPUT_POLYGONS': True,
            'CHECK_UNUSED_BOUNDARY_LINES': True,
            'CONSTRAINT_LINE_LAYERS': parameters['delimitadores_linhas_massa_dagua'],
            'CONSTRAINT_POLYGON_LAYERS': None,
            'GEOGRAPHIC_BOUNDARY': parameters['moldura'],
            'GROUP_BY_SPATIAL_PARTITION': False,
            'INPUT_CENTER_POINTS': parameters['centroide_massa_dagua'],
            'MERGE_OUTPUT_POLYGONS': False,
            'SELECTED': False,
            'SUPPRESS_AREA_WITHOUT_CENTROID_FLAG': False,
            'OUTPUT_POLYGONS': QgsProcessing.TEMPORARY_OUTPUT,
        ...
        outputs['massa_dagua'] = processing.run('dsgtools:buildpolygonsfromcenterpointsandboundariesalgorithm', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        ...
        alg_params = {
            ...
            'CONSTRAINT_POLYGON_LAYERS': [outputs['area_construida']['OUTPUT_POLYGONS'], outputs['massa_dagua']['OUTPUT_POLYGONS']],
            'GEOGRAPHIC_BOUNDARY': parameters['moldura'],
            'GROUP_BY_SPATIAL_PARTITION': False,
